...
bool colisionBorderDetection(float ObjectPositionX, float ObjectPositionY, float radius);
...
void updateobjectposition2() {
	...
	bool colisionBorder = colisionBorderDetection(ObjectPositionX2, ObjectPositionY2, radius2);
...
bool colisionBorderDetection(float ObjectPositionX, float ObjectPositionY, float radius) {
	...
	if (ObjectPositionX + radius > verticesbox[2] || ObjectPositionX - radius < verticesbox[0] || ObjectPositionY + radius > verticesbox[7] || ObjectPositionY - radius < verticesbox[1]) {
